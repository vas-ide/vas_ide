                ...
                def calculate(self):
                    ...
                    for _, __ in enumerate(self.inf_init_analiz):
                        if len(self.inf_init_analiz) == 1:
                            ...
                            if self.inf_init_analiz[1][0] == self.symbol_lst[0]:
                                self.first_arg = self.inf_init_analiz[0]
                                self.result_arg = int(self.inf_init_analiz[0])
                                for i in self.inf_init_analiz[1][1:]:
                                    if i != self.symbol_lst[2]:
                                        break
                                    else:
                                        self.result_arg += int(self.first_arg)
                            elif self.inf_init_analiz[1][0] == self.symbol_lst[1]:
                                self.result_arg = 0
                            #     counter = 1
                            ...
                            elif len(__) > 1 and len(self.inf_init_analiz) >= (_ + 2):
